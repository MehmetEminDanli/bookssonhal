...
public class AdminController : Controller
{
    ...
    [HttpGet]
    public IActionResult turedit(int id)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> turedit(TurlerVM gelenData)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> tsilmeonay(int id)
    {
    ...
    public async Task<IActionResult> DilSilOnay(int id)
    {
        ...
        return RedirectToAction("dil");
    }

    // USERS

    [Route("/Admin/kullanıcılar")]
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> kullanıcıekle(UsersVM gelenData)
    {
        if (!ModelState.IsValid)
        {
            return View(gelenData);
        ...
        return Redirect("/Admin/kullanıcılar");
    }

    [HttpGet]
    public IActionResult kullanıcıduzen(int id)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> kullanıcıduzen(UsersVM gelendata)
    {
